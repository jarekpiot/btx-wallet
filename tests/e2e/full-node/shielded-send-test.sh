...
#   AMOUNT="0.01" \
#   tests/e2e/full-node/shielded-send-test.sh
...
echo "== BTX Full Node E2E: shielded send =="
...
echo "Sending shielded transaction through full-node RPC..."
...
echo "PASS: full-node shielded send command completed."
